...
def yolo_filter_boxes(box_confidence , boxes, box_class_probs, threshold = 0.6):
    ...
    # 第四步：对scores，boxes以及classes使用掩码
...
if __name__ == '__main__':
    ...
    #     tmp = box_confidence.eval()
    #     boxes = tf.random_normal([19, 19, 5, 4], mean=1, stddev=4, seed=1)
    #     box_class_props = tf.random_normal([19, 19, 5, 80], mean=1, stddev=4, seed=1)
    #     scores, boxes, classes = yolo_filter_boxes(box_confidence, boxes, box_class_props, threshold=0.5)
    #
    ...
    # 加载存储在“yolov2.h5”中的现有预训练Keras YOLO模型
    ...
    # 把yolo_outputs添加进计算图中，将这4个tensor变量准备好用作yolo_eval函数的输入
